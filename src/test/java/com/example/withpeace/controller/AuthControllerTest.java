...
public class AuthControllerTest {
    ...
    public void loginUsingGoogleTest() throws Exception {
        ...
        given(authService.loginForMobile(accessToken, EProvider.GOOGLE)).willReturn(jwtTokenDto);
        ...
        actions.andExpect(status().isOk())
                .andExpect(jsonPath("$.data.accessToken").value(jwtTokenDto.getAccessToken()))
                .andExpect(jsonPath("$.data.refreshToken").value(jwtTokenDto.getRefreshToken()));
    }
}